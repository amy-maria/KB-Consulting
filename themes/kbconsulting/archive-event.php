...
while (have_posts()) {
    ...
    <div class="font-bold no underline'">
        <h2 class='no underline'><a class='no underline' href="<?php the_permalink(); ?>"  ><?php the_title(); ?></a></h2>
    </div>
    ...
    <div class="m-2 leading-4">
        <?php the_excerpt(); ?>
        <a href="<?php the_permalink(); ?>"class=" text-blue-500 m-2">Continue Reading</a></button>
    </div>
</div>
<?php }
echo paginate_links();
