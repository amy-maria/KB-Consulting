...
<html <?php language_attributes(); ?>>
  ...
  <a class="navbar-brand" href="<?php echo site_url("#")?>">KB Consulting</a>
...
<div class="bg-teal-700 border border-black page-banner">
  <img src="<?php echo esc_url( get_parent_theme_file_uri( 'assets/images/pexels-thecoachspace-2977565-1500X350.jpg' ) ); ?>" alt="coaching picture"> 
